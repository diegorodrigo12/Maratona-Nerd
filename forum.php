<?php
session_start();
$modo_admin = $_SESSION['admin'] ?? 0; // 1 se for admin
?>
...
<body>
  ...
  <div class="container">
    ...
    <!-- Formulário de novo tópico (somente admin) -->
<form id="new-topic-form" action="salvar_topico.php" method="POST" autocomplete="off">
  <h2>Criar novo tópico</h2>
  <input type="text" name="titulo" placeholder="Título do tópico" required maxlength="100" />
  <textarea name="conteudo" rows="5" placeholder="Conteúdo do tópico" required maxlength="1000"></textarea>
  <button type="submit">Criar tópico</button>
</form>

<!-- Lista de tópicos carregada via listar.php -->
<h2>Tópicos</h2>
<div id="topics-list">
...
<section id="topic-view" style="display:none;">
  ...
  <form id="comment-form" action="salvar_comentariof.php" method="POST" autocomplete="off">
    <input type="hidden" name="topico_id" id="topico_id">
    <textarea name="comentario" rows="3" placeholder="Escreva seu comentário aqui..." required maxlength="500"></textarea>
